const version = '1'
const versionDirectory = 'UCD' + version
// const previousVersionDirectory = 'v11'
...
module.exports = function (router) {
    ...
    router.post(['/' + versionDirectory + '/search/search-new-starting-page', '/' + versionDirectory + '/search/search-new-starting-page/'], (req, res) => {
    ...
    router.post(['/' + versionDirectory + '/search/search-all'], (req, res) => {
        if (req.body['do-you-know-permit-number'] === 'yes') {
            ...
            res.redirect('/' + versionDirectory + '/entry-points/ea/')
        }
    })
